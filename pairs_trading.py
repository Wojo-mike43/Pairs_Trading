...
if __name__ == '__main__':
    ...
    if button == True:
        ...
        with st.expander("Click Here To Read More About The Project:"):
            st.write("This project is a statistical-arbitrage pairs trading project that allows the user to select two stocks and the number of days to compare the stocks.
